...
public class RegisterActivity extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		edtxtName = (EditText)findViewById(R.id.reg_fullname);		
		edtxtEmail = (EditText)findViewById(R.id.email_txt);		
		edtxtPassword = (EditText)findViewById(R.id.password_txt);		
		edtxtConfirmPassword = (EditText) findViewById(R.id.ConfirmPassword_txt);
	...
	public void onClick(View v) {
		...
		if(UserStatus == true) {
			Intent loginPage = new Intent(RegisterActivity.this, HomeActivity.class);
